<img width="1410" height="1205" alt="image" src="https://github.com/user-attachments/assets/0f5e0208-b2d6-4dd2-aa69-53a9da2c9da0" />## 效果展示
（请将下方图片路径替换为你仓库中的实际图片路径）
- 原始图像与识别结果：
  ![装甲板灯条识别结果](result.jpg)
- 预处理阶段效果：
  灰度图像 | 二值化图像
  :---: | :---:
  ![灰度图像](gray.jpg) | ![二值化图像](binary.jpg)
